...
# PREDICCION data_ipc_usa USA AR-MA-ARIMA ------------------------------------------
...
graf<-autoplot(ts_ipc_usa)+ labs(title = "IPC anual de USA (1970-2022)",x='Fecha', y='IPC')
ggsave("ev_IPC_usa.png", graf, path = "./Graficos")
...
autoplot(train_ipc_usa2)+ labs(title = "Serie trasnformada del IPC en Usa",x='Fecha', y='IPC')

# MODELO AUTOARIMA

modeloAUTOARIMA<-auto.arima(train_ipc_usa2, seasonal = F)

auto.arima(train_ipc_usa2, seasonal = F) # arima(0,0,2)

checkresiduals(modeloAUTOARIMA)


# test_ipc_usa DE RESIDUOS
...
predicciones<-  forecast(modeloAUTOARIMA, h=6)$mean %>% diffinv(lag=1,xi=tail(train_ipc_usa,1)) 

predicciones<-(predicciones+train_ipc_usa_decom$seasonal[12:18])
autoplot(ts.union(train_ipc_usa_original,  ts(predicciones,start=c(2018,12),frequency=12)))

acuracy_AUTOARIMA<-accuracy(test_ipc_usa,ts(predicciones[2:7],start=c(2019,1),frequency=12, end=c(2019,6)))

# MODELO AR


fit100<-Arima(train_ipc_usa2, order = c(1,0,0))
fit200<-Arima(train_ipc_usa2, order = c(2,0,0))
fit300<-Arima(train_ipc_usa2, order = c(3,0,0))
fit110<-Arima(train_ipc_usa2, order = c(1,1,0))
fit210<-Arima(train_ipc_usa2, order = c(2,1,0))
fit310<-Arima(train_ipc_usa2, order = c(3,1,0))
fit120<-Arima(train_ipc_usa2, order = c(1,2,0))
fit220<-Arima(train_ipc_usa2, order = c(2,2,0))
fit320<-Arima(train_ipc_usa2, order = c(3,2,0))
...
modeloAR<-Arima(train_ipc_usa2, order=c(2,0,0))
...
predicciones<-  forecast(modeloAR,h=6)$mean %>% diffinv(lag=1,xi=tail(train_ipc_usa,1))

predicciones<-(predicciones+train_ipc_usa_decom$seasonal[12:18])

autoplot(ts.union(train_ipc_usa_original,  ts(predicciones,start=c(2018,12),frequency=12)))

acuracy_AR<-accuracy(test_ipc_usa,ts(predicciones[2:7],start=c(2019,1),frequency=12, end=c(2019,6)))

# MODELO MA
fit001<-Arima(train_ipc_usa2, order = c(0,0,1))
fit002<-Arima(train_ipc_usa2, order = c(0,0,2))
fit003<-Arima(train_ipc_usa2, order = c(0,0,3))
fit011<-Arima(train_ipc_usa2, order = c(0,1,1))
fit012<-Arima(train_ipc_usa2, order = c(0,1,2))
fit013<-Arima(train_ipc_usa2, order = c(0,1,3))
fit021<-Arima(train_ipc_usa2, order = c(0,2,1))
fit022<-Arima(train_ipc_usa2, order = c(0,2,2))
fit023<-Arima(train_ipc_usa2, order = c(0,2,3))
...
modeloMA<-Arima(train_ipc_usa2, order=c(0,0,2))
...
predicciones<-  forecast(modeloMA,h=6)$mean %>% diffinv(lag=1,xi=tail(train_ipc_usa,1))

predicciones<-(predicciones+train_ipc_usa_decom$seasonal[12:18])

autoplot(ts.union(train_ipc_usa_original,  ts(predicciones,start=c(2018,12),frequency=12)))

acuracy_MA<-accuracy(test_ipc_usa,ts(predicciones[2:7],start=c(2019,1),frequency=12, end=c(2019,6)))


# MODELOS ARMA

fit101<-Arima(train_ipc_usa2, order = c(1,0,1))
fit102<-Arima(train_ipc_usa2, order = c(1,0,2))
fit103<-Arima(train_ipc_usa2, order = c(1,0,3))
fit201<-Arima(train_ipc_usa2, order = c(2,0,1))
fit202<-Arima(train_ipc_usa2, order = c(2,0,2))
fit203<-Arima(train_ipc_usa2, order = c(2,0,3))
fit301<-Arima(train_ipc_usa2, order = c(3,0,1))
fit302<-Arima(train_ipc_usa2, order = c(3,0,2))
fit303<-Arima(train_ipc_usa2, order = c(3,0,3))
...
bestARMA # 2 -> (1,0,2) -> ARMA(1,2)

modeloARMA<-Arima(train_ipc_usa2, order=c(1,0,2))
...
predicciones<-  forecast(modeloARMA,h=6)$mean %>% diffinv(lag=1,xi=tail(train_ipc_usa,1))

predicciones<-(predicciones+train_ipc_usa_decom$seasonal[12:18])

autoplot(ts.union(train_ipc_usa_original,  ts(predicciones,start=c(2018,12),frequency=12)))

acuracy_ARMA<-accuracy(test_ipc_usa,ts(predicciones[2:7],start=c(2019,1),frequency=12, end=c(2019,6)))


#MODELO ARIMA A MANO

fit111<-Arima(train_ipc_usa2, order = c(1,1,1))
fit112<-Arima(train_ipc_usa2, order = c(1,1,2))
fit113<-Arima(train_ipc_usa2, order = c(1,1,3))
fit211<-Arima(train_ipc_usa2, order = c(2,1,1))
fit212<-Arima(train_ipc_usa2, order = c(2,1,2))
fit213<-Arima(train_ipc_usa2, order = c(2,1,3))
fit311<-Arima(train_ipc_usa2, order = c(3,1,1))
fit312<-Arima(train_ipc_usa2, order = c(3,1,2))
fit313<-Arima(train_ipc_usa2, order = c(3,1,3))

fit121<-Arima(train_ipc_usa2, order = c(1,2,1))
fit122<-Arima(train_ipc_usa2, order = c(1,2,2))
fit123<-Arima(train_ipc_usa2, order = c(1,2,3))
fit221<-Arima(train_ipc_usa2, order = c(2,2,1))
fit222<-Arima(train_ipc_usa2, order = c(2,2,2))
fit223<-Arima(train_ipc_usa2, order = c(2,2,3))
fit321<-Arima(train_ipc_usa2, order = c(3,2,1))
fit322<-Arima(train_ipc_usa2, order = c(3,2,2))
fit323<-Arima(train_ipc_usa2, order = c(3,2,3))
...
modeloARIMA_mano<-Arima(train_ipc_usa2, order=c(1,1,3))
...
predicciones<-  forecast(modeloARIMA_mano,h=6)$mean %>% diffinv(lag=1,xi=tail(train_ipc_usa,1))

predicciones<-(predicciones+train_ipc_usa_decom$seasonal[12:18])

autoplot(ts.union(train_ipc_usa_original,  ts(predicciones,start=c(2018,12),frequency=12)))

acuracy_ARIMA_mano<-accuracy(test_ipc_usa,ts(predicciones[2:7],start=c(2019,1),frequency=12, end=c(2019,6)))
...
modeloARIMAX <- auto.arima(df_ts_ipc_usa$train_ipc_usa, xreg = df_ts_ipc_francia$train_ipc_francia)
summary(modeloARIMAX) #modelo ARIMA(0,0,1)
...
predicciones<-  forecast(modeloARIMAX, xreg = rep(mean(df_ts_ipc_francia$train_ipc_francia),6), h=6)$mean %>% diffinv(lag=1,xi=tail(train_ipc_usa,1))
predicciones<-(predicciones+train_ipc_usa_decom$seasonal[12:18])
acuracy_ARIMAX<-accuracy(test_ipc_usa,ts(predicciones[2:7],start=c(2019,1),frequency=12, end=c(2019,6)))
...
RESULTADOS_ipc_USA<-cbind(modelos,resultados,aicc)
